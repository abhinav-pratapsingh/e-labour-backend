...
const getCusProfile = async (req,res)=>{
    ...
    try {
        ...
        const address = await Address.find({user:userId,role});
        res.status(200).json({success:true,message:"profile fetched successfully",customer,address});
    } catch (error) {
